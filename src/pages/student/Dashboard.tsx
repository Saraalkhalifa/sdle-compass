      ...
      <PageContainer title="Dashboard" maxWidth="xl">
        <div className="space-y-5">
          ...
          {profile && !profile.onboarding_completed && (
            <div className="flex items-center gap-4 px-5 py-4 rounded-xl bg-amber-50 border border-amber-200">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-amber-900">Complete your setup to unlock your personalized study plan</p>
                <p className="text-xs text-amber-700 mt-0.5">Takes about 5 minutes. Your answers are private.</p>
              </div>
              <Link
                to={ROUTES.onboarding}
                className="shrink-0 px-3.5 py-2 rounded-lg bg-amber-600 text-white text-sm font-semibold hover:bg-amber-700 transition-colors"
              >
                Complete setup
              </Link>
            </div>
